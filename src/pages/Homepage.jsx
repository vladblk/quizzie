...
function Homepage() {
    return (
        <>
            <svg className="blob-3" width="158" height="141" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="blob-4" width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
